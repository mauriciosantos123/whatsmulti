		...
		translations: {
			...
			connections: {
				...
				confirmationModal: {
					...
					disconnectMessage:
						"Are you sure? You'll need to read QR Code again.",
				},
				buttons: {
					add: "Add WhatsApp",
			...
			backendErrors: {
				...
				ERR_WAPP_INVALID_CONTACT:
					"This is not a valid whatsapp number.",
				...
				ERR_CREATING_MESSAGE:
					"Error while creating message on database.",
				...
				ERR_CANT_ACCEPT_TICKET: "This ticket has already been accepted",
			},
		},
	},
};
